...
export function FileButtonPage() {
  ...
  return (
    <section className='page' data-testid='page:FileButton'>
      ...
      <p className='desc'>
        Goal: onChange receives the selected file and resetRef allows re-selecting the same file
        again.
      </p>
      ...
      <div className='buttons'>
        <FileButton
          ...
          inputProps={
            { 'data-testid': 'FileButton:input' } as unknown as ComponentPropsWithoutRef<'input'>
          }
        >
          {({ onClick }) => (
